...
Review the pull request against `AGENTS.md` and the product artifacts in `docs/`.
...
- AI reliability-receipt fidelity for model, prompt, contract, evaluation, latency, tokens, cost, source, validation, and fallback evidence
...
- anonymous AI rate limiting, bounded run-ledger data, and coarse public budget exposure
