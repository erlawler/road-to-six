...
Road to Six is Eric Lawler's technical product management and frontier AI skills showcase, built with Codex as an implementation and review accelerator. Eric retained ownership of the problem, product boundaries, tradeoffs, cost envelope, risk acceptance, and release approval. Codex helped translate those decisions into working software, tests, documentation, and a public v1.0.0 release.
...
|---|---|---|
| Product direction | Selected the Cowboys championship theme and the technical product management and frontier AI showcase goal. | Converted the direction into a product brief, user flow, architecture, backlog, and repository scaffold. |
...
- This is a skills showcase prototype, not evidence of customer adoption, revenue, production scale, or a profitable betting strategy.
...
A concise and accurate project statement is:
...
The deployed runtime uses OpenAI. The product controls are intentionally provider adaptable and could support an Anthropic integration only after a separate adapter, pricing model, contract evaluation, and live validation.

Questions this showcase answers:
