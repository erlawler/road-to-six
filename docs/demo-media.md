...
![Animated Road to Six product walkthrough](media/road-to-six-demo.webp)
...
| 15.5 to 20 seconds | [Product governance](media/05-product-governance.png) | Product decisions, AI boundaries, cost controls, and release gates remain inspectable. |

## Accessibility and privacy notes

- Captions are available in the table above because the animation has no embedded audio or text track.
